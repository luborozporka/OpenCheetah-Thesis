...
uint64_t* tmp1 = make_array<uint64_t>( (int32_t)1024,  (int32_t)10);
...
Arr2DIdxRowM(tmp1, (int32_t)1024, (int32_t)10,i0,i1) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}

uint64_t* tmp2 = make_array<uint64_t>( (int32_t)2);
/* Variable to read the clear value corresponding to the input variable tmp2 at (9033,1-9033,33) */
uint64_t __tmp_in_tmp2;
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)2; i0++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp2;
}
Arr1DIdxRowM(tmp2, (int32_t)2,i0) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}

uint64_t* tmp3 = make_array<uint64_t>( (int32_t)320,  (int32_t)1024);
/* Variable to read the clear value corresponding to the input variable tmp3 at (9036,1-9036,41) */
...
Arr2DIdxRowM(tmp3, (int32_t)320, (int32_t)1024,i0,i1) = (party == SERVER) ? __tmp_in_tmp3 : 0;
}
}

uint64_t* tmp4 = make_array<uint64_t>( (int32_t)5,  (int32_t)5,  (int32_t)20,  (int32_t)20);
...
Arr4DIdxRowM(tmp4, (int32_t)5, (int32_t)5, (int32_t)20, (int32_t)20,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}
}
}
...
#endif
Conv2DWrapper( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)1,  (int32_t)5,  (int32_t)5,  (int32_t)20,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp0, tmp5, tmp6);
#if USE_CHEETAH
  kIsSharedInput = true;
#endif
...
uint64_t* tmp9 = make_array<uint64_t>( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)20);
MaxPool( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)20,  (int32_t)2,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)24,  (int32_t)24,  (int32_t)20, tmp6, tmp9);
ClearMemSecret4( (int32_t)1,  (int32_t)24,  (int32_t)24,  (int32_t)20, tmp6);

uint64_t* tmp11 = make_array<uint64_t>( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)20);
Relu4( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)20, tmp9, tmp11,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)20, tmp9);

uint64_t* tmp13 = make_array<uint64_t>( (int32_t)1,  (int32_t)8,  (int32_t)8,  (int32_t)20);
Conv2DWrapper( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)20,  (int32_t)5,  (int32_t)5,  (int32_t)20,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp11, tmp4, tmp13);
ClearMemSecret4( (int32_t)5,  (int32_t)5,  (int32_t)20,  (int32_t)20, tmp4);
ClearMemSecret4( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)20, tmp11);

uint64_t* tmp16 = make_array<uint64_t>( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)20);
MaxPool( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)20,  (int32_t)2,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)8,  (int32_t)8,  (int32_t)20, tmp13, tmp16);
ClearMemSecret4( (int32_t)1,  (int32_t)8,  (int32_t)8,  (int32_t)20, tmp13);

uint64_t* tmp18 = make_array<uint64_t>( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)20);
Relu4( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)20, tmp16, tmp18,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)20, tmp16);

uint64_t* tmp20 = make_array<uint64_t>( (int32_t)1,  (int32_t)320);
...
for (uint64_t i5 =  (int32_t)0; i5 <  (int32_t)320; i5++){
Arr2DIdxRowM(tmp20, (int32_t)1, (int32_t)320,i4,i5) = Arr4DIdxRowM(tmp18, (int32_t)1, (int32_t)4, (int32_t)4, (int32_t)20,i0,i1,i2,i3);
i3 = (i3 +  (int64_t)1);
if ((i3 ==  (int64_t)20)) {
i3 =  (int64_t)0;
i2 = (i2 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)20, tmp18);

uint64_t* tmp22 = make_array<uint64_t>( (int32_t)1,  (int32_t)1024);
MatMul2D( (int32_t)1,  (int32_t)320,  (int32_t)1024, tmp20, tmp3, tmp22, 0);
ClearMemSecret2( (int32_t)320,  (int32_t)1024, tmp3);
ClearMemSecret2( (int32_t)1,  (int32_t)320, tmp20);

uint64_t* tmp25 = make_array<uint64_t>( (int32_t)1,  (int32_t)1024);
Relu2( (int32_t)1,  (int32_t)1024, tmp22, tmp25,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)1024, tmp22);

uint64_t* tmp27 = make_array<uint64_t>( (int32_t)1,  (int32_t)10);
MatMul2D( (int32_t)1,  (int32_t)1024,  (int32_t)10, tmp25, tmp1, tmp27, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)1024, tmp25);
ClearMemSecret2( (int32_t)1024,  (int32_t)10, tmp1);
...
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)1; i0++){
    for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)10; i1++){
        auto pred = funcReconstruct2PCCons(Arr2DIdxRowM(tmp30, (int32_t)1, (int32_t)10,i0,i1), 2);
        if (party == CLIENT) {
		  printf("predicted label = %lld\n", pred);
		}
    }
}
CreateIdentity22( (int32_t)1,  (int32_t)10, tmp27, tmp30);
