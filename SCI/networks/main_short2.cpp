...
// Add
amap.arg("k", kScale, "scaling factor"); // same as sf here, also 12
...
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)28; i1++){
for (uint64_t i2 =  (uint64_t)0; i2 <  (int32_t)28; i2++){
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)1; i3++){
if ((party == CLIENT)) {
cin >> __tmp_in_tmp0;
}
Arr4DIdxRowM(tmp0, (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)1,i0,i1,i2,i3) = (party == CLIENT) ? __tmp_in_tmp0 : 0;
}
}
}
}

uint64_t* tmp1 = make_array<uint64_t>( (int32_t)1338,  (int32_t)10);
/* Variable to read the clear value corresponding to the input variable tmp1 at (9030,1-9030,40) */
uint64_t __tmp_in_tmp1;
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)1338; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)10; i1++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp1;
}
Arr2DIdxRowM(tmp1, (int32_t)1338, (int32_t)10,i0,i1) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}

uint64_t* tmp2 = make_array<uint64_t>( (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)25);
/* Variable to read the clear value corresponding to the input variable tmp2 at (9033,1-9033,43) */
...
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)25; i3++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp2;
}
Arr4DIdxRowM(tmp2, (int32_t)5, (int32_t)5, (int32_t)1, (int32_t)25,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}
}
}

uint64_t* tmp3 = make_array<uint64_t>( (int32_t)5,  (int32_t)5,  (int32_t)25,  (int32_t)25);
/* Variable to read the clear value corresponding to the input variable tmp3 at (9036,1-9036,44) */
uint64_t __tmp_in_tmp3;
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)5; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)5; i1++){
for (uint64_t i2 =  (uint64_t)0; i2 <  (int32_t)25; i2++){
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)25; i3++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp3;
}
Arr4DIdxRowM(tmp3, (int32_t)5, (int32_t)5, (int32_t)25, (int32_t)25,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp3 : 0;
}
}
}
}

uint64_t* tmp4 = make_array<uint64_t>( (int32_t)50,  (int32_t)1338);
/* Variable to read the clear value corresponding to the input variable tmp4 at (9039,1-9039,40) */
uint64_t __tmp_in_tmp4;
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)50; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)1338; i1++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp4;
}
Arr2DIdxRowM(tmp4, (int32_t)50, (int32_t)1338,i0,i1) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}

uint64_t* tmp5 = make_array<uint64_t>( (int32_t)2,  (int32_t)2,  (int32_t)25,  (int32_t)50);
...
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)2; i1++){
for (uint64_t i2 =  (uint64_t)0; i2 <  (int32_t)25; i2++){
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)50; i3++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp5;
}
Arr4DIdxRowM(tmp5, (int32_t)2, (int32_t)2, (int32_t)25, (int32_t)50,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}
}
}
}

uint64_t* tmp6 = make_array<uint64_t>( (int32_t)2);
...
Arr1DIdxRowM(tmp6, (int32_t)2,i0) = (party == SERVER) ? __tmp_in_tmp6 : 0;
}
std::cerr << "input loaded, starting computation..." << std::endl;
StartComputation();

uint64_t* tmp7 = make_array<uint64_t>( (int32_t)1,  (int32_t)24,  (int32_t)24,  (int32_t)25);
...
Conv2DWrapper( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)1,  (int32_t)5,  (int32_t)5,  (int32_t)25,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp0, tmp2, tmp7);

// Add
#if USE_CHEETAH
  kIsSharedInput = true;
#endif
ClearMemSecret4( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)1, tmp0);
ClearMemSecret4( (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)25, tmp2);

uint64_t* tmp10 = make_array<uint64_t>( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)25);
MaxPool( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)25,  (int32_t)2,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)24,  (int32_t)24,  (int32_t)25, tmp7, tmp10);
ClearMemSecret4( (int32_t)1,  (int32_t)24,  (int32_t)24,  (int32_t)25, tmp7);

uint64_t* tmp12 = make_array<uint64_t>( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)25);
Relu4( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)25, tmp10, tmp12,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)25, tmp10);

uint64_t* tmp14 = make_array<uint64_t>( (int32_t)1,  (int32_t)8,  (int32_t)8,  (int32_t)25);
Conv2DWrapper( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)25,  (int32_t)5,  (int32_t)5,  (int32_t)25,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp12, tmp3, tmp14);
ClearMemSecret4( (int32_t)5,  (int32_t)5,  (int32_t)25,  (int32_t)25, tmp3);
ClearMemSecret4( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)25, tmp12);

uint64_t* tmp17 = make_array<uint64_t>( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)25);
MaxPool( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)25,  (int32_t)2,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)8,  (int32_t)8,  (int32_t)25, tmp14, tmp17);
ClearMemSecret4( (int32_t)1,  (int32_t)8,  (int32_t)8,  (int32_t)25, tmp14);

uint64_t* tmp19 = make_array<uint64_t>( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)25);
Relu4( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)25, tmp17, tmp19,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)25, tmp17);

uint64_t* tmp21 = make_array<uint64_t>( (int32_t)1,  (int32_t)3,  (int32_t)3,  (int32_t)50);
Conv2DWrapper( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)25,  (int32_t)2,  (int32_t)2,  (int32_t)50,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp19, tmp5, tmp21);
ClearMemSecret4( (int32_t)2,  (int32_t)2,  (int32_t)25,  (int32_t)50, tmp5);
ClearMemSecret4( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)25, tmp19);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)50);
MaxPool( (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)50,  (int32_t)2,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)3,  (int32_t)3,  (int32_t)50, tmp21, tmp24);
ClearMemSecret4( (int32_t)1,  (int32_t)3,  (int32_t)3,  (int32_t)50, tmp21);

uint64_t* tmp26 = make_array<uint64_t>( (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)50);
Relu4( (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)50, tmp24, tmp26,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)50, tmp24);

uint64_t* tmp28 = make_array<uint64_t>( (int32_t)1,  (int32_t)50);
...
for (uint64_t i5 =  (int32_t)0; i5 <  (int32_t)50; i5++){
Arr2DIdxRowM(tmp28, (int32_t)1, (int32_t)50,i4,i5) = Arr4DIdxRowM(tmp26, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)50,i0,i1,i2,i3);
i3 = (i3 +  (int64_t)1);
if ((i3 ==  (int64_t)50)) {
i3 =  (int64_t)0;
i2 = (i2 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)50, tmp26);

uint64_t* tmp30 = make_array<uint64_t>( (int32_t)1,  (int32_t)1338);
MatMul2D( (int32_t)1,  (int32_t)50,  (int32_t)1338, tmp28, tmp4, tmp30, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)50, tmp28);
ClearMemSecret2( (int32_t)50,  (int32_t)1338, tmp4);

uint64_t* tmp33 = make_array<uint64_t>( (int32_t)1,  (int32_t)1338);
Relu2( (int32_t)1,  (int32_t)1338, tmp30, tmp33,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)1338, tmp30);

uint64_t* tmp35 = make_array<uint64_t>( (int32_t)1,  (int32_t)10);
MatMul2D( (int32_t)1,  (int32_t)1338,  (int32_t)10, tmp33, tmp1, tmp35, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)1338, tmp33);
ClearMemSecret2( (int32_t)1338,  (int32_t)10, tmp1);
