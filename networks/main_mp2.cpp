...
Arr4DIdxRowM(tmp0, (int32_t)1, (int32_t)128, (int32_t)128, (int32_t)1,i0,i1,i2,i3) = (party == CLIENT) ? __tmp_in_tmp0 : 0;
}
}
}
}

uint64_t* tmp1 = make_array<uint64_t>( (int32_t)4,  (int32_t)1338);
/* Variable to read the clear value corresponding to the input variable tmp1 at (9030,1-9030,39) */
...
Arr2DIdxRowM(tmp1, (int32_t)4, (int32_t)1338,i0,i1) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}
...
uint64_t* tmp3 = make_array<uint64_t>( (int32_t)1338,  (int32_t)10);
...
#endif
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)1,  (int32_t)124,  (int32_t)127,  (int32_t)1);
MaxPool( (int32_t)1,  (int32_t)124,  (int32_t)127,  (int32_t)1,  (int32_t)5,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)128,  (int32_t)128,  (int32_t)1, tmp0, tmp4);
ClearMemSecret4( (int32_t)1,  (int32_t)128,  (int32_t)128,  (int32_t)1, tmp0);
#if USE_CHEETAH
  kIsSharedInput = true;
#endif
uint64_t* tmp6 = make_array<uint64_t>( (int32_t)1,  (int32_t)123,  (int32_t)124,  (int32_t)1);
MaxPool( (int32_t)1,  (int32_t)123,  (int32_t)124,  (int32_t)1,  (int32_t)2,  (int32_t)4,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)124,  (int32_t)127,  (int32_t)1, tmp4, tmp6);
ClearMemSecret4( (int32_t)1,  (int32_t)124,  (int32_t)127,  (int32_t)1, tmp4);

uint64_t* tmp8 = make_array<uint64_t>( (int32_t)1,  (int32_t)31,  (int32_t)30,  (int32_t)1);
MaxPool( (int32_t)1,  (int32_t)31,  (int32_t)30,  (int32_t)1,  (int32_t)2,  (int32_t)5,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)4,  (int32_t)4,  (int32_t)1,  (int32_t)123,  (int32_t)124,  (int32_t)1, tmp6, tmp8);
ClearMemSecret4( (int32_t)1,  (int32_t)123,  (int32_t)124,  (int32_t)1, tmp6);

uint64_t* tmp10 = make_array<uint64_t>( (int32_t)1,  (int32_t)7,  (int32_t)6,  (int32_t)1);
MaxPool( (int32_t)1,  (int32_t)7,  (int32_t)6,  (int32_t)1,  (int32_t)1,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)31,  (int32_t)30,  (int32_t)1, tmp8, tmp10);
ClearMemSecret4( (int32_t)1,  (int32_t)31,  (int32_t)30,  (int32_t)1, tmp8);

uint64_t* tmp12 = make_array<uint64_t>( (int32_t)1,  (int32_t)2,  (int32_t)2,  (int32_t)1);
MaxPool( (int32_t)1,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)3,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)4,  (int32_t)4,  (int32_t)1,  (int32_t)7,  (int32_t)6,  (int32_t)1, tmp10, tmp12);
ClearMemSecret4( (int32_t)1,  (int32_t)7,  (int32_t)6,  (int32_t)1, tmp10);

uint64_t* tmp14 = make_array<uint64_t>( (int32_t)1,  (int32_t)4);
...
for (uint64_t i5 =  (int32_t)0; i5 <  (int32_t)4; i5++){
Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)4,i4,i5) = Arr4DIdxRowM(tmp12, (int32_t)1, (int32_t)2, (int32_t)2, (int32_t)1,i0,i1,i2,i3);
i3 = (i3 +  (int64_t)1);
if ((i3 ==  (int64_t)1)) {
i3 =  (int64_t)0;
i2 = (i2 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)1,  (int32_t)2,  (int32_t)2,  (int32_t)1, tmp12);

uint64_t* tmp16 = make_array<uint64_t>( (int32_t)1,  (int32_t)1338);
MatMul2D( (int32_t)1,  (int32_t)4,  (int32_t)1338, tmp14, tmp1, tmp16, 0);
ClearMemSecret2( (int32_t)4,  (int32_t)1338, tmp1);
ClearMemSecret2( (int32_t)1,  (int32_t)4, tmp14);
...
MatMul2D( (int32_t)1,  (int32_t)1338,  (int32_t)10, tmp19, tmp3, tmp21, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)1338, tmp19);
ClearMemSecret2( (int32_t)1338,  (int32_t)10, tmp3);
