...
uint64_t* tmp0 = make_array<uint64_t>( (int32_t)1,  (int32_t)4096,  (int32_t)4096,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp0 at (9027,1-9027,48) */
uint64_t __tmp_in_tmp0;
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)1; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)4096; i1++){
for (uint64_t i2 =  (uint64_t)0; i2 <  (int32_t)4096; i2++){
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)1; i3++){
if ((party == CLIENT)) {
cin >> __tmp_in_tmp0;
}
Arr4DIdxRowM(tmp0, (int32_t)1, (int32_t)4096, (int32_t)4096, (int32_t)1,i0,i1,i2,i3) = (party == CLIENT) ? __tmp_in_tmp0 : 0;
}
}
}
}

uint64_t* tmp1 = make_array<uint64_t>( (int32_t)5,  (int32_t)5,  (int32_t)46,  (int32_t)68);
/* Variable to read the clear value corresponding to the input variable tmp1 at (9030,1-9030,44) */
uint64_t __tmp_in_tmp1;
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)5; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)5; i1++){
for (uint64_t i2 =  (uint64_t)0; i2 <  (int32_t)46; i2++){
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)68; i3++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp1;
}
Arr4DIdxRowM(tmp1, (int32_t)5, (int32_t)5, (int32_t)46, (int32_t)68,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}
}
}

uint64_t* tmp2 = make_array<uint64_t>( (int32_t)9,  (int32_t)7,  (int32_t)22,  (int32_t)46);
/* Variable to read the clear value corresponding to the input variable tmp2 at (9033,1-9033,44) */
uint64_t __tmp_in_tmp2;
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)9; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)7; i1++){
for (uint64_t i2 =  (uint64_t)0; i2 <  (int32_t)22; i2++){
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)46; i3++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp2;
}
Arr4DIdxRowM(tmp2, (int32_t)9, (int32_t)7, (int32_t)22, (int32_t)46,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}
}
}

uint64_t* tmp3 = make_array<uint64_t>( (int32_t)4,  (int32_t)3,  (int32_t)20,  (int32_t)91);
...
for (uint64_t i2 =  (uint64_t)0; i2 <  (int32_t)20; i2++){
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)91; i3++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp3;
}
Arr4DIdxRowM(tmp3, (int32_t)4, (int32_t)3, (int32_t)20, (int32_t)91,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp3 : 0;
}
}
}
}

uint64_t* tmp4 = make_array<uint64_t>( (int32_t)225,  (int32_t)1024);
/* Variable to read the clear value corresponding to the input variable tmp4 at (9039,1-9039,41) */
uint64_t __tmp_in_tmp4;
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)225; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)1024; i1++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp4;
}
Arr2DIdxRowM(tmp4, (int32_t)225, (int32_t)1024,i0,i1) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}

uint64_t* tmp5 = make_array<uint64_t>( (int32_t)2,  (int32_t)3,  (int32_t)91,  (int32_t)12);
...
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)3; i1++){
for (uint64_t i2 =  (uint64_t)0; i2 <  (int32_t)91; i2++){
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)12; i3++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp5;
}
Arr4DIdxRowM(tmp5, (int32_t)2, (int32_t)3, (int32_t)91, (int32_t)12,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}
}
}
}

uint64_t* tmp6 = make_array<uint64_t>( (int32_t)9,  (int32_t)9,  (int32_t)68,  (int32_t)40);
/* Variable to read the clear value corresponding to the input variable tmp6 at (9045,1-9045,44) */
uint64_t __tmp_in_tmp6;
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)9; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)9; i1++){
for (uint64_t i2 =  (uint64_t)0; i2 <  (int32_t)68; i2++){
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)40; i3++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp6;
}
Arr4DIdxRowM(tmp6, (int32_t)9, (int32_t)9, (int32_t)68, (int32_t)40,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp6 : 0;
}
}
}
}

uint64_t* tmp7 = make_array<uint64_t>( (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)20);
...
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)20; i3++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp7;
}
Arr4DIdxRowM(tmp7, (int32_t)5, (int32_t)5, (int32_t)1, (int32_t)20,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp7 : 0;
}
}
}
}

uint64_t* tmp8 = make_array<uint64_t>( (int32_t)9,  (int32_t)8,  (int32_t)12,  (int32_t)22);
/* Variable to read the clear value corresponding to the input variable tmp8 at (9051,1-9051,44) */
uint64_t __tmp_in_tmp8;
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)9; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)8; i1++){
for (uint64_t i2 =  (uint64_t)0; i2 <  (int32_t)12; i2++){
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)22; i3++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp8;
}
Arr4DIdxRowM(tmp8, (int32_t)9, (int32_t)8, (int32_t)12, (int32_t)22,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp8 : 0;
}
}
}
}

uint64_t* tmp9 = make_array<uint64_t>( (int32_t)1024,  (int32_t)10);
/* Variable to read the clear value corresponding to the input variable tmp9 at (9054,1-9054,40) */
...
Arr2DIdxRowM(tmp9, (int32_t)1024, (int32_t)10,i0,i1) = (party == SERVER) ? __tmp_in_tmp9 : 0;
}
}

uint64_t* tmp10 = make_array<uint64_t>( (int32_t)10,  (int32_t)4,  (int32_t)40,  (int32_t)75);
...
for (uint64_t i2 =  (uint64_t)0; i2 <  (int32_t)40; i2++){
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)75; i3++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp10;
}
Arr4DIdxRowM(tmp10, (int32_t)10, (int32_t)4, (int32_t)40, (int32_t)75,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp10 : 0;
}
}
}
}

uint64_t* tmp11 = make_array<uint64_t>( (int32_t)2);
/* Variable to read the clear value corresponding to the input variable tmp11 at (9060,1-9060,34) */
uint64_t __tmp_in_tmp11;
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)2; i0++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp11;
}
Arr1DIdxRowM(tmp11, (int32_t)2,i0) = (party == SERVER) ? __tmp_in_tmp11 : 0;
}
StartComputation();
#if USE_CHEETAH
...
uint64_t* tmp12 = make_array<uint64_t>( (int32_t)1,  (int32_t)4092,  (int32_t)4092,  (int32_t)20);
Conv2DWrapper( (int32_t)1,  (int32_t)4096,  (int32_t)4096,  (int32_t)1,  (int32_t)5,  (int32_t)5,  (int32_t)20,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp0, tmp7, tmp12);
ClearMemSecret4( (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)20, tmp7);
ClearMemSecret4( (int32_t)1,  (int32_t)4096,  (int32_t)4096,  (int32_t)1, tmp0);
// Add
#if USE_CHEETAH
  kIsSharedInput = true;
#endif
uint64_t* tmp15 = make_array<uint64_t>( (int32_t)1,  (int32_t)1364,  (int32_t)1363,  (int32_t)20);
MaxPool( (int32_t)1,  (int32_t)1364,  (int32_t)1363,  (int32_t)20,  (int32_t)3,  (int32_t)5,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)3,  (int32_t)3,  (int32_t)1,  (int32_t)4092,  (int32_t)4092,  (int32_t)20, tmp12, tmp15);
ClearMemSecret4( (int32_t)1,  (int32_t)4092,  (int32_t)4092,  (int32_t)20, tmp12);

uint64_t* tmp17 = make_array<uint64_t>( (int32_t)1,  (int32_t)1364,  (int32_t)1363,  (int32_t)20);
Relu4( (int32_t)1,  (int32_t)1364,  (int32_t)1363,  (int32_t)20, tmp15, tmp17,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)1364,  (int32_t)1363,  (int32_t)20, tmp15);

uint64_t* tmp19 = make_array<uint64_t>( (int32_t)1,  (int32_t)1361,  (int32_t)1361,  (int32_t)91);
Conv2DWrapper( (int32_t)1,  (int32_t)1364,  (int32_t)1363,  (int32_t)20,  (int32_t)4,  (int32_t)3,  (int32_t)91,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp17, tmp3, tmp19);
ClearMemSecret4( (int32_t)4,  (int32_t)3,  (int32_t)20,  (int32_t)91, tmp3);
ClearMemSecret4( (int32_t)1,  (int32_t)1364,  (int32_t)1363,  (int32_t)20, tmp17);

uint64_t* tmp22 = make_array<uint64_t>( (int32_t)1,  (int32_t)679,  (int32_t)680,  (int32_t)91);
MaxPool( (int32_t)1,  (int32_t)679,  (int32_t)680,  (int32_t)91,  (int32_t)4,  (int32_t)3,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)1361,  (int32_t)1361,  (int32_t)91, tmp19, tmp22);
ClearMemSecret4( (int32_t)1,  (int32_t)1361,  (int32_t)1361,  (int32_t)91, tmp19);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)1,  (int32_t)679,  (int32_t)680,  (int32_t)91);
Relu4( (int32_t)1,  (int32_t)679,  (int32_t)680,  (int32_t)91, tmp22, tmp24,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)679,  (int32_t)680,  (int32_t)91, tmp22);

uint64_t* tmp26 = make_array<uint64_t>( (int32_t)1,  (int32_t)678,  (int32_t)678,  (int32_t)12);
Conv2DWrapper( (int32_t)1,  (int32_t)679,  (int32_t)680,  (int32_t)91,  (int32_t)2,  (int32_t)3,  (int32_t)12,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp24, tmp5, tmp26);
ClearMemSecret4( (int32_t)2,  (int32_t)3,  (int32_t)91,  (int32_t)12, tmp5);
ClearMemSecret4( (int32_t)1,  (int32_t)679,  (int32_t)680,  (int32_t)91, tmp24);

uint64_t* tmp29 = make_array<uint64_t>( (int32_t)1,  (int32_t)339,  (int32_t)338,  (int32_t)12);
MaxPool( (int32_t)1,  (int32_t)339,  (int32_t)338,  (int32_t)12,  (int32_t)1,  (int32_t)3,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)678,  (int32_t)678,  (int32_t)12, tmp26, tmp29);
ClearMemSecret4( (int32_t)1,  (int32_t)678,  (int32_t)678,  (int32_t)12, tmp26);

uint64_t* tmp31 = make_array<uint64_t>( (int32_t)1,  (int32_t)339,  (int32_t)338,  (int32_t)12);
Relu4( (int32_t)1,  (int32_t)339,  (int32_t)338,  (int32_t)12, tmp29, tmp31,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)339,  (int32_t)338,  (int32_t)12, tmp29);

uint64_t* tmp33 = make_array<uint64_t>( (int32_t)1,  (int32_t)331,  (int32_t)331,  (int32_t)22);
Conv2DWrapper( (int32_t)1,  (int32_t)339,  (int32_t)338,  (int32_t)12,  (int32_t)9,  (int32_t)8,  (int32_t)22,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp31, tmp8, tmp33);
ClearMemSecret4( (int32_t)1,  (int32_t)339,  (int32_t)338,  (int32_t)12, tmp31);
ClearMemSecret4( (int32_t)9,  (int32_t)8,  (int32_t)12,  (int32_t)22, tmp8);

uint64_t* tmp36 = make_array<uint64_t>( (int32_t)1,  (int32_t)330,  (int32_t)328,  (int32_t)22);
MaxPool( (int32_t)1,  (int32_t)330,  (int32_t)328,  (int32_t)22,  (int32_t)2,  (int32_t)4,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)331,  (int32_t)331,  (int32_t)22, tmp33, tmp36);
ClearMemSecret4( (int32_t)1,  (int32_t)331,  (int32_t)331,  (int32_t)22, tmp33);

uint64_t* tmp38 = make_array<uint64_t>( (int32_t)1,  (int32_t)330,  (int32_t)328,  (int32_t)22);
Relu4( (int32_t)1,  (int32_t)330,  (int32_t)328,  (int32_t)22, tmp36, tmp38,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)330,  (int32_t)328,  (int32_t)22, tmp36);

uint64_t* tmp40 = make_array<uint64_t>( (int32_t)1,  (int32_t)322,  (int32_t)322,  (int32_t)46);
Conv2DWrapper( (int32_t)1,  (int32_t)330,  (int32_t)328,  (int32_t)22,  (int32_t)9,  (int32_t)7,  (int32_t)46,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp38, tmp2, tmp40);
ClearMemSecret4( (int32_t)9,  (int32_t)7,  (int32_t)22,  (int32_t)46, tmp2);
ClearMemSecret4( (int32_t)1,  (int32_t)330,  (int32_t)328,  (int32_t)22, tmp38);

uint64_t* tmp43 = make_array<uint64_t>( (int32_t)1,  (int32_t)65,  (int32_t)65,  (int32_t)46);
MaxPool( (int32_t)1,  (int32_t)65,  (int32_t)65,  (int32_t)46,  (int32_t)2,  (int32_t)1,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)322,  (int32_t)322,  (int32_t)46, tmp40, tmp43);
ClearMemSecret4( (int32_t)1,  (int32_t)322,  (int32_t)322,  (int32_t)46, tmp40);

uint64_t* tmp45 = make_array<uint64_t>( (int32_t)1,  (int32_t)65,  (int32_t)65,  (int32_t)46);
Relu4( (int32_t)1,  (int32_t)65,  (int32_t)65,  (int32_t)46, tmp43, tmp45,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)65,  (int32_t)65,  (int32_t)46, tmp43);

uint64_t* tmp47 = make_array<uint64_t>( (int32_t)1,  (int32_t)61,  (int32_t)61,  (int32_t)68);
Conv2DWrapper( (int32_t)1,  (int32_t)65,  (int32_t)65,  (int32_t)46,  (int32_t)5,  (int32_t)5,  (int32_t)68,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp45, tmp1, tmp47);
ClearMemSecret4( (int32_t)5,  (int32_t)5,  (int32_t)46,  (int32_t)68, tmp1);
ClearMemSecret4( (int32_t)1,  (int32_t)65,  (int32_t)65,  (int32_t)46, tmp45);

uint64_t* tmp50 = make_array<uint64_t>( (int32_t)1,  (int32_t)61,  (int32_t)59,  (int32_t)68);
MaxPool( (int32_t)1,  (int32_t)61,  (int32_t)59,  (int32_t)68,  (int32_t)1,  (int32_t)3,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)61,  (int32_t)61,  (int32_t)68, tmp47, tmp50);
ClearMemSecret4( (int32_t)1,  (int32_t)61,  (int32_t)61,  (int32_t)68, tmp47);

uint64_t* tmp52 = make_array<uint64_t>( (int32_t)1,  (int32_t)61,  (int32_t)59,  (int32_t)68);
Relu4( (int32_t)1,  (int32_t)61,  (int32_t)59,  (int32_t)68, tmp50, tmp52,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)61,  (int32_t)59,  (int32_t)68, tmp50);

uint64_t* tmp54 = make_array<uint64_t>( (int32_t)1,  (int32_t)53,  (int32_t)51,  (int32_t)40);
Conv2DWrapper( (int32_t)1,  (int32_t)61,  (int32_t)59,  (int32_t)68,  (int32_t)9,  (int32_t)9,  (int32_t)40,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp52, tmp6, tmp54);
ClearMemSecret4( (int32_t)1,  (int32_t)61,  (int32_t)59,  (int32_t)68, tmp52);
ClearMemSecret4( (int32_t)9,  (int32_t)9,  (int32_t)68,  (int32_t)40, tmp6);

uint64_t* tmp57 = make_array<uint64_t>( (int32_t)1,  (int32_t)11,  (int32_t)10,  (int32_t)40);
MaxPool( (int32_t)1,  (int32_t)11,  (int32_t)10,  (int32_t)40,  (int32_t)1,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)53,  (int32_t)51,  (int32_t)40, tmp54, tmp57);
ClearMemSecret4( (int32_t)1,  (int32_t)53,  (int32_t)51,  (int32_t)40, tmp54);

uint64_t* tmp59 = make_array<uint64_t>( (int32_t)1,  (int32_t)11,  (int32_t)10,  (int32_t)40);
Relu4( (int32_t)1,  (int32_t)11,  (int32_t)10,  (int32_t)40, tmp57, tmp59,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)11,  (int32_t)10,  (int32_t)40, tmp57);

uint64_t* tmp61 = make_array<uint64_t>( (int32_t)1,  (int32_t)2,  (int32_t)7,  (int32_t)75);
Conv2DWrapper( (int32_t)1,  (int32_t)11,  (int32_t)10,  (int32_t)40,  (int32_t)10,  (int32_t)4,  (int32_t)75,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp59, tmp10, tmp61);
ClearMemSecret4( (int32_t)1,  (int32_t)11,  (int32_t)10,  (int32_t)40, tmp59);
ClearMemSecret4( (int32_t)10,  (int32_t)4,  (int32_t)40,  (int32_t)75, tmp10);

uint64_t* tmp64 = make_array<uint64_t>( (int32_t)1,  (int32_t)1,  (int32_t)3,  (int32_t)75);
MaxPool( (int32_t)1,  (int32_t)1,  (int32_t)3,  (int32_t)75,  (int32_t)2,  (int32_t)1,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)3,  (int32_t)3,  (int32_t)1,  (int32_t)2,  (int32_t)7,  (int32_t)75, tmp61, tmp64);
ClearMemSecret4( (int32_t)1,  (int32_t)2,  (int32_t)7,  (int32_t)75, tmp61);

uint64_t* tmp66 = make_array<uint64_t>( (int32_t)1,  (int32_t)1,  (int32_t)3,  (int32_t)75);
Relu4( (int32_t)1,  (int32_t)1,  (int32_t)3,  (int32_t)75, tmp64, tmp66,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)1,  (int32_t)3,  (int32_t)75, tmp64);

uint64_t* tmp68 = make_array<uint64_t>( (int32_t)1,  (int32_t)225);
...
for (uint64_t i5 =  (int32_t)0; i5 <  (int32_t)225; i5++){
Arr2DIdxRowM(tmp68, (int32_t)1, (int32_t)225,i4,i5) = Arr4DIdxRowM(tmp66, (int32_t)1, (int32_t)1, (int32_t)3, (int32_t)75,i0,i1,i2,i3);
i3 = (i3 +  (int64_t)1);
if ((i3 ==  (int64_t)75)) {
i3 =  (int64_t)0;
i2 = (i2 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)1,  (int32_t)1,  (int32_t)3,  (int32_t)75, tmp66);

uint64_t* tmp70 = make_array<uint64_t>( (int32_t)1,  (int32_t)1024);
MatMul2D( (int32_t)1,  (int32_t)225,  (int32_t)1024, tmp68, tmp4, tmp70, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)225, tmp68);
ClearMemSecret2( (int32_t)225,  (int32_t)1024, tmp4);

uint64_t* tmp73 = make_array<uint64_t>( (int32_t)1,  (int32_t)1024);
Relu2( (int32_t)1,  (int32_t)1024, tmp70, tmp73,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)1024, tmp70);

uint64_t* tmp75 = make_array<uint64_t>( (int32_t)1,  (int32_t)10);
MatMul2D( (int32_t)1,  (int32_t)1024,  (int32_t)10, tmp73, tmp9, tmp75, 0);
ClearMemSecret2( (int32_t)1024,  (int32_t)10, tmp9);
ClearMemSecret2( (int32_t)1,  (int32_t)1024, tmp73);

uint64_t* tmp78 = make_array<uint64_t>( (int32_t)1,  (int32_t)10);
ScaleDown2( (int32_t)1,  (int32_t)10, tmp75,  (int32_t)12);
CreateIdentity22( (int32_t)1,  (int32_t)10, tmp75, tmp78);
ClearMemSecret2( (int32_t)1,  (int32_t)10, tmp75);
EndComputation();
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)1; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)10; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp78, (int32_t)1, (int32_t)10,i0,i1), 2)) << endl;
}
}
}
