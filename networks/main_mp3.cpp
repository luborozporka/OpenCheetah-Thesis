...
uint64_t* tmp2 = make_array<uint64_t>( (int32_t)40804,  (int32_t)1338);
/* Variable to read the clear value corresponding to the input variable tmp2 at (9033,1-9033,43) */
uint64_t __tmp_in_tmp2;
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)40804; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)1338; i1++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp2;
}
Arr2DIdxRowM(tmp2, (int32_t)40804, (int32_t)1338,i0,i1) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}
...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)1,  (int32_t)2047,  (int32_t)2048,  (int32_t)1);
MaxPool( (int32_t)1,  (int32_t)2047,  (int32_t)2048,  (int32_t)1,  (int32_t)3,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)4096,  (int32_t)4096,  (int32_t)1, tmp0, tmp4);
ClearMemSecret4( (int32_t)1,  (int32_t)4096,  (int32_t)4096,  (int32_t)1, tmp0);

uint64_t* tmp6 = make_array<uint64_t>( (int32_t)1,  (int32_t)409,  (int32_t)409,  (int32_t)1);
MaxPool( (int32_t)1,  (int32_t)409,  (int32_t)409,  (int32_t)1,  (int32_t)3,  (int32_t)5,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)2047,  (int32_t)2048,  (int32_t)1, tmp4, tmp6);
ClearMemSecret4( (int32_t)1,  (int32_t)2047,  (int32_t)2048,  (int32_t)1, tmp4);

uint64_t* tmp8 = make_array<uint64_t>( (int32_t)1,  (int32_t)409,  (int32_t)409,  (int32_t)1);
MaxPool( (int32_t)1,  (int32_t)409,  (int32_t)409,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)409,  (int32_t)409,  (int32_t)1, tmp6, tmp8);
ClearMemSecret4( (int32_t)1,  (int32_t)409,  (int32_t)409,  (int32_t)1, tmp6);

uint64_t* tmp10 = make_array<uint64_t>( (int32_t)1,  (int32_t)407,  (int32_t)408,  (int32_t)1);
MaxPool( (int32_t)1,  (int32_t)407,  (int32_t)408,  (int32_t)1,  (int32_t)3,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)409,  (int32_t)409,  (int32_t)1, tmp8, tmp10);
ClearMemSecret4( (int32_t)1,  (int32_t)409,  (int32_t)409,  (int32_t)1, tmp8);

uint64_t* tmp12 = make_array<uint64_t>( (int32_t)1,  (int32_t)202,  (int32_t)202,  (int32_t)1);
MaxPool( (int32_t)1,  (int32_t)202,  (int32_t)202,  (int32_t)1,  (int32_t)4,  (int32_t)5,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)407,  (int32_t)408,  (int32_t)1, tmp10, tmp12);
ClearMemSecret4( (int32_t)1,  (int32_t)407,  (int32_t)408,  (int32_t)1, tmp10);

uint64_t* tmp14 = make_array<uint64_t>( (int32_t)1,  (int32_t)40804);
...
for (uint64_t i5 =  (int32_t)0; i5 <  (int32_t)40804; i5++){
Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)40804,i4,i5) = Arr4DIdxRowM(tmp12, (int32_t)1, (int32_t)202, (int32_t)202, (int32_t)1,i0,i1,i2,i3);
i3 = (i3 +  (int64_t)1);
if ((i3 ==  (int64_t)1)) {
i3 =  (int64_t)0;
i2 = (i2 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)1,  (int32_t)202,  (int32_t)202,  (int32_t)1, tmp12);

uint64_t* tmp16 = make_array<uint64_t>( (int32_t)1,  (int32_t)1338);
MatMul2D( (int32_t)1,  (int32_t)40804,  (int32_t)1338, tmp14, tmp2, tmp16, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)40804, tmp14);
ClearMemSecret2( (int32_t)40804,  (int32_t)1338, tmp2);

uint64_t* tmp19 = make_array<uint64_t>( (int32_t)1,  (int32_t)1338);
Relu2( (int32_t)1,  (int32_t)1338, tmp16, tmp19,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)1338, tmp16);

uint64_t* tmp21 = make_array<uint64_t>( (int32_t)1,  (int32_t)10);
MatMul2D( (int32_t)1,  (int32_t)1338,  (int32_t)10, tmp19, tmp1, tmp21, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)1338, tmp19);
ClearMemSecret2( (int32_t)1338,  (int32_t)10, tmp1);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)1,  (int32_t)10);
...
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)1; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)10; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp24, (int32_t)1, (int32_t)10,i0,i1), 2)) << endl;
}
}
}
