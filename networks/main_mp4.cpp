...
uint64_t* tmp0 = make_array<uint64_t>( (int32_t)1,  (int32_t)1024,  (int32_t)1024,  (int32_t)1);
...
Arr4DIdxRowM(tmp0, (int32_t)1, (int32_t)1024, (int32_t)1024, (int32_t)1,i0,i1,i2,i3) = (party == CLIENT) ? __tmp_in_tmp0 : 0;
}
}
}
}

uint64_t* tmp1 = make_array<uint64_t>( (int32_t)1800,  (int32_t)1024);
/* Variable to read the clear value corresponding to the input variable tmp1 at (9030,1-9030,42) */
uint64_t __tmp_in_tmp1;
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)1800; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)1024; i1++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp1;
}
Arr2DIdxRowM(tmp1, (int32_t)1800, (int32_t)1024,i0,i1) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}

uint64_t* tmp2 = make_array<uint64_t>( (int32_t)1024,  (int32_t)10);
/* Variable to read the clear value corresponding to the input variable tmp2 at (9033,1-9033,40) */
...
Arr2DIdxRowM(tmp2, (int32_t)1024, (int32_t)10,i0,i1) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}

uint64_t* tmp3 = make_array<uint64_t>( (int32_t)2);
...
Arr1DIdxRowM(tmp3, (int32_t)2,i0) = (party == SERVER) ? __tmp_in_tmp3 : 0;
}

uint64_t* tmp4 = make_array<uint64_t>( (int32_t)10,  (int32_t)1,  (int32_t)20,  (int32_t)39);
...
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)39; i3++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp4;
}
Arr4DIdxRowM(tmp4, (int32_t)10, (int32_t)1, (int32_t)20, (int32_t)39,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}
}
}

uint64_t* tmp5 = make_array<uint64_t>( (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)20);
...
Arr4DIdxRowM(tmp5, (int32_t)5, (int32_t)5, (int32_t)1, (int32_t)20,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}
}
}
}

uint64_t* tmp6 = make_array<uint64_t>( (int32_t)6,  (int32_t)8,  (int32_t)39,  (int32_t)8);
/* Variable to read the clear value corresponding to the input variable tmp6 at (9045,1-9045,43) */
uint64_t __tmp_in_tmp6;
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)6; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)8; i1++){
for (uint64_t i2 =  (uint64_t)0; i2 <  (int32_t)39; i2++){
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)8; i3++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp6;
}
Arr4DIdxRowM(tmp6, (int32_t)6, (int32_t)8, (int32_t)39, (int32_t)8,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp6 : 0;
}
}
}
}
...
#endif
uint64_t* tmp7 = make_array<uint64_t>( (int32_t)1,  (int32_t)1020,  (int32_t)1020,  (int32_t)20);
Conv2DWrapper( (int32_t)1,  (int32_t)1024,  (int32_t)1024,  (int32_t)1,  (int32_t)5,  (int32_t)5,  (int32_t)20,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp0, tmp5, tmp7);
ClearMemSecret4( (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)20, tmp5);
ClearMemSecret4( (int32_t)1,  (int32_t)1024,  (int32_t)1024,  (int32_t)1, tmp0);
#if USE_CHEETAH
  kIsSharedInput = true;
#endif
uint64_t* tmp10 = make_array<uint64_t>( (int32_t)1,  (int32_t)255,  (int32_t)255,  (int32_t)20);
MaxPool( (int32_t)1,  (int32_t)255,  (int32_t)255,  (int32_t)20,  (int32_t)4,  (int32_t)1,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)4,  (int32_t)4,  (int32_t)1,  (int32_t)1020,  (int32_t)1020,  (int32_t)20, tmp7, tmp10);
ClearMemSecret4( (int32_t)1,  (int32_t)1020,  (int32_t)1020,  (int32_t)20, tmp7);

uint64_t* tmp12 = make_array<uint64_t>( (int32_t)1,  (int32_t)255,  (int32_t)255,  (int32_t)20);
Relu4( (int32_t)1,  (int32_t)255,  (int32_t)255,  (int32_t)20, tmp10, tmp12,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)255,  (int32_t)255,  (int32_t)20, tmp10);

uint64_t* tmp14 = make_array<uint64_t>( (int32_t)1,  (int32_t)246,  (int32_t)255,  (int32_t)39);
Conv2DWrapper( (int32_t)1,  (int32_t)255,  (int32_t)255,  (int32_t)20,  (int32_t)10,  (int32_t)1,  (int32_t)39,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp12, tmp4, tmp14);
ClearMemSecret4( (int32_t)1,  (int32_t)255,  (int32_t)255,  (int32_t)20, tmp12);
ClearMemSecret4( (int32_t)10,  (int32_t)1,  (int32_t)20,  (int32_t)39, tmp4);

uint64_t* tmp17 = make_array<uint64_t>( (int32_t)1,  (int32_t)82,  (int32_t)85,  (int32_t)39);
MaxPool( (int32_t)1,  (int32_t)82,  (int32_t)85,  (int32_t)39,  (int32_t)3,  (int32_t)1,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)3,  (int32_t)3,  (int32_t)1,  (int32_t)246,  (int32_t)255,  (int32_t)39, tmp14, tmp17);
ClearMemSecret4( (int32_t)1,  (int32_t)246,  (int32_t)255,  (int32_t)39, tmp14);

uint64_t* tmp19 = make_array<uint64_t>( (int32_t)1,  (int32_t)82,  (int32_t)85,  (int32_t)39);
Relu4( (int32_t)1,  (int32_t)82,  (int32_t)85,  (int32_t)39, tmp17, tmp19,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)82,  (int32_t)85,  (int32_t)39, tmp17);

uint64_t* tmp21 = make_array<uint64_t>( (int32_t)1,  (int32_t)77,  (int32_t)78,  (int32_t)8);
Conv2DWrapper( (int32_t)1,  (int32_t)82,  (int32_t)85,  (int32_t)39,  (int32_t)6,  (int32_t)8,  (int32_t)8,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp19, tmp6, tmp21);
ClearMemSecret4( (int32_t)1,  (int32_t)82,  (int32_t)85,  (int32_t)39, tmp19);
ClearMemSecret4( (int32_t)6,  (int32_t)8,  (int32_t)39,  (int32_t)8, tmp6);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)1,  (int32_t)15,  (int32_t)15,  (int32_t)8);
MaxPool( (int32_t)1,  (int32_t)15,  (int32_t)15,  (int32_t)8,  (int32_t)3,  (int32_t)5,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)77,  (int32_t)78,  (int32_t)8, tmp21, tmp24);
ClearMemSecret4( (int32_t)1,  (int32_t)77,  (int32_t)78,  (int32_t)8, tmp21);

uint64_t* tmp26 = make_array<uint64_t>( (int32_t)1,  (int32_t)15,  (int32_t)15,  (int32_t)8);
Relu4( (int32_t)1,  (int32_t)15,  (int32_t)15,  (int32_t)8, tmp24, tmp26,  (int32_t)12, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)15,  (int32_t)15,  (int32_t)8, tmp24);

uint64_t* tmp28 = make_array<uint64_t>( (int32_t)1,  (int32_t)1800);
...
for (uint64_t i5 =  (int32_t)0; i5 <  (int32_t)1800; i5++){
Arr2DIdxRowM(tmp28, (int32_t)1, (int32_t)1800,i4,i5) = Arr4DIdxRowM(tmp26, (int32_t)1, (int32_t)15, (int32_t)15, (int32_t)8,i0,i1,i2,i3);
i3 = (i3 +  (int64_t)1);
if ((i3 ==  (int64_t)8)) {
i3 =  (int64_t)0;
i2 = (i2 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)1,  (int32_t)15,  (int32_t)15,  (int32_t)8, tmp26);

uint64_t* tmp30 = make_array<uint64_t>( (int32_t)1,  (int32_t)1024);
MatMul2D( (int32_t)1,  (int32_t)1800,  (int32_t)1024, tmp28, tmp1, tmp30, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)1800, tmp28);
ClearMemSecret2( (int32_t)1800,  (int32_t)1024, tmp1);

uint64_t* tmp33 = make_array<uint64_t>( (int32_t)1,  (int32_t)1024);
Relu2( (int32_t)1,  (int32_t)1024, tmp30, tmp33,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)1024, tmp30);

uint64_t* tmp35 = make_array<uint64_t>( (int32_t)1,  (int32_t)10);
MatMul2D( (int32_t)1,  (int32_t)1024,  (int32_t)10, tmp33, tmp2, tmp35, 0);
ClearMemSecret2( (int32_t)1024,  (int32_t)10, tmp2);
ClearMemSecret2( (int32_t)1,  (int32_t)1024, tmp33);

uint64_t* tmp38 = make_array<uint64_t>( (int32_t)1,  (int32_t)10);
ScaleDown2( (int32_t)1,  (int32_t)10, tmp35,  (int32_t)12);
CreateIdentity22( (int32_t)1,  (int32_t)10, tmp35, tmp38);
ClearMemSecret2( (int32_t)1,  (int32_t)10, tmp35);
EndComputation();
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)1; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)10; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp38, (int32_t)1, (int32_t)10,i0,i1), 2)) << endl;
}
}
}
