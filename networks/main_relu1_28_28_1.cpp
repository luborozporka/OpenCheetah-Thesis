...
uint64_t* tmp1 = make_array<uint64_t>( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)1);
Relu4( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)1, tmp0, tmp1,  (int32_t)0, 0);
ClearMemSecret4( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)1, tmp0);

uint64_t* tmp3 = make_array<uint64_t>( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)1);
CreateIdentity44( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)1, tmp1, tmp3);
ClearMemSecret4( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)1, tmp1);
EndComputation();
for (uint64_t i0 =  (uint64_t)0; i0 <  (int32_t)1; i0++){
for (uint64_t i1 =  (uint64_t)0; i1 <  (int32_t)28; i1++){
for (uint64_t i2 =  (uint64_t)0; i2 <  (int32_t)28; i2++){
for (uint64_t i3 =  (uint64_t)0; i3 <  (int32_t)1; i3++){
cout << (funcReconstruct2PCCons(Arr4DIdxRowM(tmp3, (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)1,i0,i1,i2,i3), 2)) << endl;
}
}
}
}
